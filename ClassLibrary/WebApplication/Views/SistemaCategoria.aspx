    ...
    <script>
        var waitingDialog = waitingDialog || (function ($) {
            ...
            var $dialog = $(
                ...
                '<div class="modal-footer"><button runat="server" onclick="javascript:window.history.go(-1);" type="button" class="btn btn-default">Voltar</button><button runat="server" onclick="chamarAjax();" type="button" class="btn btn-primary">Continuar...</button></div>' +
                '</div>' +
                '</div></div></div>');
