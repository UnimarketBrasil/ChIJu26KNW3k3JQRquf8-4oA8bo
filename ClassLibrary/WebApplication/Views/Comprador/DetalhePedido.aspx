<%@ Page Title="" Language="C#" MasterPageFile="~/Comprar.Master" AutoEventWireup="true" CodeBehind="DetalhePedido.aspx.cs" Inherits="WebApplication.DetalhePedidoComprador" %>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <asp:Label runat="server" ID="lbVendedor" Text="" CssClass="form-control"></asp:Label>
                        </div>
